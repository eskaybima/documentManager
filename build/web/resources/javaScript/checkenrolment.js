function ajaxFunction2() {
                    ...
                    if (ajaxRequest.readyState == 4) {
                        if (ajaxRequest.status == 200) {
                            ...
                            if (ajaxRequest.responseText.replace(/\s+/g, '') == "Exits") {
                               Alert.render('The Enrolment number you entered already exist on the system');
                ...
                var age = document.getElementById('enrolNo').value;
                var queryString = "?age=" + age;
                ajaxRequest.open("GET", "checkenrolnum" + queryString, true);
