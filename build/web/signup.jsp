					...
					<div class="col-md-12 login" style="padding-top:25px;">
						<div align="center">
							<i class="text1"><b class="fa fa-user-plus"></b> SIGN UP</i>
                                                ...
                                                <form id="loginForm" name='loginForm'  action="Login" class="form-horizontal">
						  <div class="form-group">
								<div class="input-group algn">
									<span class="input-group-addon text-mutex">
										<i class="fa fa-user"></i>
									</span>
									<input type="text" name="uname" id="uname" class="form-control" width="85%" placeholder="User Name" required/>
								</div>
							</div><br/>
								...
								<div class="input-group algn">
									<span class="input-group-addon text-mutex">
										<i class="fa fa-envelope"></i>
                                                                        ...
                                                                        <input type="hidden" name="signup" id="signup" class="form-control" width="85%" value="signup"/>
									<input type="text" name="email" id="email" class="form-control" width="85%" placeholder="E-mail" required/>
								</div>
							</div><br/>
							<div class="form-group">
								<div class="input-group algn">
									...
									<input type="text" name="dname" id="dname" class="form-control" width="85%" placeholder="Peferred display name" required/>
								</div>
							</div><br/>
							...
							<div class="form-group">
								<div class="input-group algn">
									...
									<input type="password" name="passcode" id="passcode" class="form-control" width="85%" placeholder="Password" required/>
								</div>
							</div><br/>
							<div class="form-group">
								<div class="input-group algn">
									...
									<input type="password" name="confirm" id="confirm" class="form-control" width="85%" placeholder="Confirm Password" required/>
								</div>
							</div><br/>
								...
								<div class="input-group algn">
									...
									<input type="text" name="location" id="location" class="form-control" width="85%" placeholder="Location" required/>
								</div>
							</div><br/>
							...
							<div class="form-group">
								<div class="input-group algn">
									...
									<select name="coyType" id="coyType" class="form-control" width="85%" required/>
							...
							<div align="center">
								<i class="text2"> By clicking Sign up, I agree to the Terms & Conditions.</i>
							</div><br/>
							<div class="row">
								<div class="col-md-offset-4 col-md-4">
						                <button type="submit" class="btn btn-xs btn-primary btn-block"> Sign up </button>
								</div>
							</div><br>
						</form>
					</div>
