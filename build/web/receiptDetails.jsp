...
<html>
	...
	<style>
        ...
        <%
        amtdue = request.getParameter("amtDue");
        amtPd = request.getParameter("amtPd");
        bal = request.getParameter("bal");
        name = sb.getValue2("select first_name from fas_mst_users where user_id = '" + (String)session.getAttribute("username") + "'");
        %>
	...
	<body>
		<div class="page-container">
			...
			<div class="row col-md-12" style="padding-top:50px">
				<div class="col-md-offset-1 col-md-10 rcpt" style="padding-top:25px; margin-bottom: 50px;">
					<div align="center">
						<img src="source/img/img.png" alt="..." width="20%" height="20%">
						<p>
							<h2 class="text1"> OYO STATE INTERNAL REVENUE BOARD </h2>
						</p>
						<p>
							<h4 class="text1"> INCOME TAX CLEARANCE CERTIFICATE </h4>
						</p>
					</div>
					<div class="row col-md-12">
						<div class="col-md-offset-10 col-md-2">
							<p>The Registrar,</p>
							<p>Board of Internal Revenue,</p>
							<p>Oyo state, Nigeria.</p>
                                                        <p><%= request.getParameter("payDate").substring(0, 10) %></p>
						</div>
					</div>
					<div class="row col-md-12">
						<div class="col-md-3">
							...
							<p><%= name %></p>
							<p>142, Fajuyi Road,</p>
							<p>Moko, Adamasingba, Ibadan,</p>
							<p>Oyo state, Nigeria.</p>
						</div>
					</div>
					<div class="row col-md-12 text1" align="center">
						<hr>PROOF OF PAYMENT<hr>
					</div>
					<div class="row">
						&nbsp;
					</div>
					<div class="row">
						<div class="col-md-offset-2 col-md-8 text3">
							<div class="col-md-3">Name of Payee:</div><div class="col-md-6"> <%= name %></div><br/>
                                                        <div class="col-md-3">Transaction date:</div><div class="col-md-6"> <%= request.getParameter("payDate").substring(0, 10) %></div><br/>
							<div class="col-md-3">Amount Paid:</div><div class="col-md-6"><%= request.getParameter("amtPd") %></div><br/>
							<div class="col-md-3">Balance:</div><div class="col-md-6"> <%=bal%></div><br/>
							<div class="col-md-3">Form of payment:</div><div class="col-md-6"> via Oyo state BIR Portal</div><br/>
						</div>
					</div><hr>
				</div>
			</div>
			<div class="row col-md-12 text-column-info" align="center" style="color: #fff; padding-top:765px">
