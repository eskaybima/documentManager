...
<%!
String fuel_requisition_form= "";
List<String> fuel_requisition_formlist;
String supplier_name= "";
List<String> supplier_namelist;
String supplier_address= "";
List<String> supplier_addresslist;
String volume_of_fuel= "";
List<String> volume_of_fuellist;
String price_for_fuel= "";
List<String> price_for_fuellist;
...
fuel_requisition_form= (String) request.getAttribute("fuel_requisition_form");
supplier_name= (String) request.getAttribute("supplier_name");
supplier_address= (String) request.getAttribute("supplier_address");
volume_of_fuel= (String) request.getAttribute("volume_of_fuel");
price_for_fuel= (String) request.getAttribute("price_for_fuel");
...
<div class="panel-body"><div class="modal-header"><h3>FUEL REQUISITION</h3><div class="clear"></div></div>
...
<div class="modal-header"><span class="h5 text-info"> FUEL REQUISITION FORM</strong></span></div><br>
<div class="form-group">
<label class="col-md-3 col-xs-12 control-label">SUPPLIER NAME:</label>
<div class="col-md-6 col-xs-12">
<input type="text" class="form-control" placeholder=" SUPPLIER NAME" name="supplier_name" value="<%=supplier_name%>" id="supplier_name"  onchange="renderElseWhere('supplier_name', 'loghc')"/>
</div>
</div>
<div class="form-group">
<label class="col-md-3 col-xs-12 control-label">SUPPLIER ADDRESS:</label>
<div class="col-md-6 col-xs-12">
<input type="text" class="form-control" placeholder=" SUPPLIER ADDRESS" name="supplier_address" value="<%=supplier_address%>" id="supplier_address"  onchange="renderElseWhere('supplier_address', 'loghc')"/>
</div>
</div>
<div class="form-group">
<label class="col-md-3 col-xs-12 control-label">VOLUME OF FUEL:</label>
<div class="col-md-6 col-xs-12">
<input type="text" class="form-control" placeholder=" VOLUME OF FUEL" name="volume_of_fuel" value="<%=volume_of_fuel%>" id="volume_of_fuel"  onchange="renderElseWhere('volume_of_fuel', 'loghc')"/>
</div>
</div>
<div class="form-group">
<label class="col-md-3 col-xs-12 control-label">PRICE FOR FUEL:</label>
<div class="col-md-6 col-xs-12">
<input type="text" class="form-control" placeholder=" PRICE FOR FUEL" name="price_for_fuel" value="<%=price_for_fuel%>" id="price_for_fuel"  onchange="renderElseWhere('price_for_fuel', 'loghc')"/>
</div>
</div>
<div class="form-group">
