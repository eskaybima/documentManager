...
List<String> marital_statuslist;
String state= "";
...
%>
<%
titlelist = sb.getList2("select param_value from param_values_CLIENTS_DETAIL where parameter_name ='title'");
full_namelist = sb.getList2("select param_value from param_values_CLIENTS_DETAIL where parameter_name ='full_name'");
addresslist = sb.getList2("select param_value from param_values_CLIENTS_DETAIL where parameter_name ='address'");
marital_statuslist = sb.getList2("select param_value from param_values_CLIENTS_DETAIL where parameter_name ='marital_status'");
statelist = sb.getList2("select param_value from param_values_CLIENTS_DETAIL where parameter_name ='state'");
countrylist = sb.getList2("select param_value from param_values_CLIENTS_DETAIL where parameter_name ='country'");
...
marital_status= (String) request.getAttribute("marital_status");
...
<div class="panel-body tab-content"><div class="modal-header"><h3>CLIENTS DETAIL</h3><div class="clear"></div></div>
...
<div class="form-group">
<label class="col-md-3 col-xs-12 control-label">FULL_NAME:</label>
<div class="col-md-6 col-xs-12">
 <div class="input-group">
<span class="input-group-addon"><span class="fa fa-barcode"></span></span>
...
<div class="form-group">
<label class="col-md-3 col-xs-12 control-label">MARITAL_STATUS:</label>
<div class="col-md-6 col-xs-12">
 <div class="input-group">
<span class="input-group-addon"><span class="fa fa-barcode"></span></span>
<% if (marital_statuslist.isEmpty()) {%>
<input type="text" class="form-control" placeholder=" marital_status" name="marital_status" value="<%=marital_status%>" id="marital_status"  onchange="renderElseWhere('marital_status', 'loghc')"/>
<%} else {%>
<select name="marital_status" value="<%=marital_status%>" id="marital_status" onchange="renderElseWhere('marital_status', 'loghc')" />
<option value="<%=marital_status%>"><%=marital_status%></option>
<% for (int i = 0; i < marital_statuslist.size(); i++) {%>
<option value="<%=marital_statuslist.get(i)%>"><%=marital_statuslist.get(i)%></option>
<%}%>
</select>
<%}%>
</div>
