...
String template = "FORM_A23";
boolean isdocAvailable;
%>
<%
titlelist = sb.getList2("select distinct param_value from param_values_FORM_A23 where parameter_name ='title' order by param_value asc ");
...
<div class="panel-body"><div class="modal-header"><h3>Staff Record</h3><div class="clear"></div></div>
...
<div class="col-md-6 col-xs-12">
 <select type="text" class="form-control select" name="jobType" value="" id="jobType" onchange="renderElseWhere6('jobType', 'loghc')" />
    <option value=""></option>
   <% if (!imageList.contains("proof_of_id")) {%>
    <option value="proof_of_id">Proof of Id</option>
   <% } %>
  </select>
