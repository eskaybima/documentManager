    ...
    <head>
        ...
        <div class="page-container">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">General Cumulative Report</li>
            </ul>
            <!-- END BREADCRUMB -->
            <div id="bodyhold">
                <div id="bodycon">  
            ...
            <div class="col-md-offset-2 col-md-8">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><span class="fa fa-map-marker"></span> <strong>General Cumulative Report</strong></h3>
                    ...
                    <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                     <form action="${pageContext.request.contextPath}/Statistic" method="get">
                                        <input type="hidden" name="repType" value="cumulativeperLocation"/>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="well well-sm h5"><strong>Cumulative Report As At : <%= new java.util.Date()%></strong></div>
                            </div>
                        </div>
                        <div class="thumbnail">
                            <div class="row">
