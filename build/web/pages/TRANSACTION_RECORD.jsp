...
String payee_name= "";
List<String> payee_namelist;
String transaction_detail= "";
List<String> transaction_detaillist;
String ref_id;
...
%>
<%
amountlist = sb.getList2("select param_value from param_values where parameter_name ='amount'");
payer_namelist = sb.getList2("select param_value from param_values where parameter_name ='payer_name'");
payee_namelist = sb.getList2("select param_value from param_values where parameter_name ='payee_name'");
transaction_detaillist = sb.getList2("select param_value from param_values where parameter_name ='transaction_detail'");
...
payee_name= (String) request.getAttribute("payee_name");
transaction_detail= (String) request.getAttribute("transaction_detail");
}
%>
<div class="page-content-wrap">
<div class="row">
<div class="col-md-offset-1 col-md-10">
<div class="panel-body tab-content"><div class="modal-header"><h3>TRANSACTION RECORD</h3><div class="clear"></div></div>
...
<%} else {%>
<select name="amount" value="<%=amount%>" id="amount" onchange="renderElseWhere('amount', 'loghc')" />
...
<div class="form-group">
<label class="col-md-3 col-xs-12 control-label">PAYER NAME:</label>
<div class="col-md-6 col-xs-12">
 <div class="input-group">
<span class="input-group-addon"><span class="fa fa-barcode"></span></span>
<% if (payer_namelist.isEmpty()) {%>
<input type="text" class="form-control" placeholder=" PAYER NAME" name="payer_name" value="<%=payer_name%>" id="payer_name"  onchange="renderElseWhere('payer_name', 'loghc')"/>
<%} else {%>
...
<div class="col-md-6 col-xs-12">
 <div class="input-group">
<span class="input-group-addon"><span class="fa fa-barcode"></span></span>
<% if (payee_namelist.isEmpty()) {%>
<input type="text" class="form-control" placeholder=" PAYEE NAME" name="payee_name" value="<%=payee_name%>" id="payee_name"  onchange="renderElseWhere('payee_name', 'loghc')"/>
<%} else {%>
<select name="payee_name" value="<%=payee_name%>" id="payee_name" onchange="renderElseWhere('payee_name', 'loghc')" />
<option value="<%=payee_name%>"><%=payee_name%></option>
<% for (int i = 0; i < payee_namelist.size(); i++) {%>
<option value="<%=payee_namelist.get(i)%>"><%=payee_namelist.get(i)%></option>
<%}%>
</select>
<%}%>
</div>
...
<div class="form-group">
<label class="col-md-3 col-xs-12 control-label">TRANSACTION DETAIL:</label>
<div class="col-md-6 col-xs-12">
 <div class="input-group">
<span class="input-group-addon"><span class="fa fa-barcode"></span></span>
<% if (transaction_detaillist.isEmpty()) {%>
<input type="text" class="form-control" placeholder=" TRANSACTION DETAIL" name="transaction_detail" value="<%=transaction_detail%>" id="transaction_detail"  onchange="renderElseWhere('transaction_detail', 'loghc')"/>
<%} else {%>
<select name="transaction_detail" value="<%=transaction_detail%>" id="transaction_detail" onchange="renderElseWhere('transaction_detail', 'loghc')" />
<option value="<%=transaction_detail%>"><%=transaction_detail%></option>
<% for (int i = 0; i < transaction_detaillist.size(); i++) {%>
<option value="<%=transaction_detaillist.get(i)%>"><%=transaction_detaillist.get(i)%></option>
<%}%>
</select>
<%}%>
</div>
