...
organisationlist = sb.getList2("select param_value from param_values where parameter_name ='organisation'");
...
organisation= (String) request.getAttribute("organisation");
}
%>
...
<input type="text" class="form-control" placeholder=" ORGANISATION" name="organisation" value="<%=organisation%>" id="organisation"  onchange="renderElseWhere('organisation', 'loghc')"/>
<%} else {%>
<select name="organisation" value="<%=organisation%>" id="organisation" onchange="renderElseWhere('organisation', 'loghc')" />
<option value="<%=organisation%>"><%=organisation%></option>
<% for (int i = 0; i < organisationlist.size(); i++) {%>
<option value="<%=organisationlist.get(i)%>"><%=organisationlist.get(i)%></option>
<%}%>
</select>
<%}%>
</div>
