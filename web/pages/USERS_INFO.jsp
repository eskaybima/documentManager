...
%>
<%
titlelist = sb.getList2("select param_value from param_values_USERS INFO where parameter_name ='title'");
full_namelist = sb.getList2("select param_value from param_values_USERS INFO where parameter_name ='full_name'");
rolelist = sb.getList2("select param_value from param_values_USERS INFO where parameter_name ='role'");
street_addresslist = sb.getList2("select param_value from param_values_USERS INFO where parameter_name ='street_address'");
lgalist = sb.getList2("select param_value from param_values_USERS INFO where parameter_name ='lga'");
statelist = sb.getList2("select param_value from param_values_USERS INFO where parameter_name ='state'");
...
<div class="panel-body tab-content"><div class="modal-header"><h3>USERS INFO</h3><div class="clear"></div></div>
