...
List<String> name_of_organisationlist;
String ref_id;
...
name_of_organisationlist = sb.getList2("select param_value from param_values where parameter_name ='name_of_organisation'");
...
<div class="col-md-6 col-xs-12">
 <div class="input-group">
<span class="input-group-addon"><span class="fa fa-barcode"></span></span>
<% if (name_of_organisationlist.isEmpty()) {%>
<input type="text" class="form-control" placeholder=" NAME OF ORGANISATION" name="name_of_organisation" value="<%=name_of_organisation%>" id="name_of_organisation"  onchange="renderElseWhere('name_of_organisation', 'loghc')"/>
<%} else {%>
<select name="name_of_organisation" value="<%=name_of_organisation%>" id="name_of_organisation" onchange="renderElseWhere('name_of_organisation', 'loghc')" />
<option value="<%=name_of_organisation%>"><%=name_of_organisation%></option>
<% for (int i = 0; i < name_of_organisationlist.size(); i++) {%>
<option value="<%=name_of_organisationlist.get(i)%>"><%=name_of_organisationlist.get(i)%></option>
<%}%>
</select>
<%}%>
</div>
...
<div class="col-md-6 col-xs-12">
 <select type="text" class="form-control select" name="jobType" value="" id="jobType" onchange="renderElseWhere6('jobType', 'loghc')" />
    <option value=""></option>
   <% if (!imageList.contains("certificate_of_registration")) {%>
