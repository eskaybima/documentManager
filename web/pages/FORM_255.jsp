                ...
                <div id="bodyhold">
                    <div id="bodycon">
                        ...
                        <%!
                            ...
                            String volume_in_liters = "";
                            List<String> volume_in_literslist;
                            String ref_id;
                            List<String> imageList;
                            List<String> stateList;
                            List<String> countryList;
                            SaveToDb sb = new SaveToDb();
                            String template = "FORM_255";
                            boolean isdocAvailable;
                        %>
                        <%
                            statelist = sb.getList2("select distinct param_value from param_values_FORM_255 where parameter_name ='state' order by param_value asc ");
                            ...
                            if ((String) request.getAttribute("offset") != null) {
                                ...
                                volume_in_liters = (String) request.getAttribute("volume_in_liters");
                            }
                        %>
                            ...
                            <div class="row">
                                <div class="col-md-offset-1 col-md-10">
                                    <div class="panel panel-primary">
                                        <div class="panel-body"><div class="modal-header"><h3>KEROSENE REQUEST</h3><div class="clear"></div></div>
