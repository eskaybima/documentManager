...
List<String> requester_namelist;
String store_name= "";
List<String> store_namelist;
String total_number= "";
List<String> total_numberlist;
String request_for_toilet_rolls= "";
List<String> request_for_toilet_rollslist;
String ref_id;
List<String> imageList;
List<String> stateList;
List<String> countryList;
SaveToDb sb = new SaveToDb();
String template = "RWQUEST_FOR_TOILET_ROLLS";
...
requester_name= (String) request.getAttribute("requester_name");
store_name= (String) request.getAttribute("store_name");
total_number= (String) request.getAttribute("total_number");
request_for_toilet_rolls= (String) request.getAttribute("request_for_toilet_rolls");
}
%>
...
<div class="panel-body"><div class="modal-header"><h3>RWQUEST FOR TOILET ROLLS</h3><div class="clear"></div></div>
...
<div class="form-group">
<label class="col-md-3 col-xs-12 control-label">REQUESTER NAME:</label>
<div class="col-md-6 col-xs-12">
<input type="text" class="form-control" placeholder=" Requester Name" name="requester_name" value="<%=requester_name%>" id="requester_name"  onchange="renderElseWhere('requester_name', 'loghc')"/>
</div>
</div>
<div class="form-group">
<label class="col-md-3 col-xs-12 control-label">STORE NAME:</label>
<div class="col-md-6 col-xs-12">
<input type="text" class="form-control" placeholder=" Store Name" name="store_name" value="<%=store_name%>" id="store_name"  onchange="renderElseWhere('store_name', 'loghc')"/>
</div>
</div>
<div class="form-group">
...
<div class="modal-header"><span class="h5 text-info"> REQUEST FOR TOILET ROLLS</strong></span></div><br>
<div class="form-group">
