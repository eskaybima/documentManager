...
%>
<%
titlelist = sb.getList2("select param_value from param_values_CUSTOMER INFO where parameter_name ='title'");
full_namelist = sb.getList2("select param_value from param_values_CUSTOMER INFO where parameter_name ='full_name'");
street_addresslist = sb.getList2("select param_value from param_values_CUSTOMER INFO where parameter_name ='street_address'");
lgalist = sb.getList2("select param_value from param_values_CUSTOMER INFO where parameter_name ='lga'");
statelist = sb.getList2("select param_value from param_values_CUSTOMER INFO where parameter_name ='state'");
...
<div class="panel-body tab-content"><div class="modal-header"><h3>CUSTOMER INFO</h3><div class="clear"></div></div>
...
<div class="col-md-6 col-xs-12">
 <select type="text" class="form-control select" name="jobType" value="" id="jobType" onchange="renderElseWhere6('jobType', 'loghc')" />
    <option value=""></option>
   <% if (!imageList.contains("drivers_licence")) {%>
