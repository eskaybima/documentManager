...
%>
<%
tax_idlist = sb.getList2("select param_value from param_values where parameter_name ='tax_id'");
...
<label class="control-label">
    <input type="text" value ="<%= ref_id%>" readonly="true"/>
...
<div class="col-md-6 col-xs-12">
 <select type="text" class="form-control select" name="jobType" value="" id="jobType" onchange="renderElseWhere6('jobType', 'loghc')" />
   ...
   <% } %>
   <% if (!imageList.contains("registration_form")) {%>
    <option value="registration_form">registration_form</option>
   <% } %>
